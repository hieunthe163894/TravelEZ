          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <h2>
                  Thưởng thức hương vị tinh tế và không gian sang trọng tại các
                  nhà hàng hàng đầu Nhà hàng hàng đầu
                </h2>
                <p>
                  Bắt tay vào hành trình ẩm thực của bạn với chúng tôi! Tại đây,
                  bạn sẽ khám phá những hương vị mới và độc đáo, cùng với bầu
                  không khí thoải mái và dịch vụ chuyên nghiệp. Hãy đặt bàn ngay
                  hôm nay và chuẩn bị cho trải nghiệm ẩm thực đặc biệt cùng bạn
                  bè và gia đình.
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <p>
                  Trang web đặt bàn của chúng tôi là địa chỉ tin cậy để bạn đặt
                  chỗ tại nhà hàng một cách thuận tiện và nhanh chóng, đảm bảo
                  dịch vụ chất lượng.
                </p>
              </div>
